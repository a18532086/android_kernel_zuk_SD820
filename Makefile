...
HOSTCC       = ccache gcc
HOSTCXX      = ccache g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -Ofast -fomit-frame-pointer -Wno-uninitialized -fno-inline-functions -std=gnu89
HOSTCXXFLAGS = -Ofast
...
KBUILD_CFLAGS	+= -Ofast $(call cc-option,-fno-inline-functions)
endif
